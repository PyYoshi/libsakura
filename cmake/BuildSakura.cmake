...
set(SOURCE_FILES ${LIBSAKURA_HOME}/Sakura.cpp)
set(HEADER_FILES ${LIBSAKURA_HOME}/Sakura.h)
...
set(MAIN_SOURCE_FILES ${LIBSAKURA_HOME}/main.cpp)
add_executable(${SAKURA_EXECUTABLE} ${MAIN_SOURCE_FILES})
add_dependencies(${SAKURA_EXECUTABLE} ${SAKURA_STATIC_LIBRARY})
target_link_libraries(${SAKURA_EXECUTABLE} ${SAKURA_DEPENDENCIES} ${PROJECT_SOURCE_DIR}/libsakura.a)
